...
use ExternalImporter\application\vendor\openai\OpenAi;
...
abstract class AiClient
{
	...
	public static function models()
	{
		$models = array(
			'gpt-3.5-turbo' => array(
				'name' => 'OpenAI: gpt-3.5-turbo' . ' ' . __('(recommended)', 'external-importer'),
			...
			'claude-3-haiku-20240307' => array(
				'name' => 'Claude 3: haiku' . ' ' . __('(recommended)', 'external-importer'),
	...
	protected function getTemporaryDirectory()
	{
		...
		$dir = $upload_dir['basedir'] . '/ei-debug-ai';
